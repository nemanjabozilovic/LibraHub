...
namespace LibraHub.Content.Infrastructure.Messaging;

public class ContentEventPublisher : IOutboxWriter
{
    private readonly ContentDbContext _context;
    private readonly JsonSerializerOptions _jsonOptions;

    public ContentEventPublisher(ContentDbContext context)
    {
        _context = context;
